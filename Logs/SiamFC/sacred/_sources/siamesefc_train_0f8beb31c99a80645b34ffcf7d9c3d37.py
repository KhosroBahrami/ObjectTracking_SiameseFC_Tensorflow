...
def main(model_config, train_config, track_config):
  ...
  with g.as_default():
    ...
    total_steps = int(data_config['epoch'] * data_config['num_examples_per_epoch'] / data_config['batch_size'])
    ...
    for step in range(start_step, total_steps):
      ...
      if step % 10 == 0:
        ...
        logging.info(format_str % (datetime.now(), step, loss, batch_loss, examples_per_sec, duration, h, m, s))
